# 🚛 GreenStream Logistics: Oracle 23ai Performance & Vector RAG Case Study
...
**Solution:** Implementation of an "AI DBA" – an autonomous agent that:
...
| :--- | :--- | :--- | :--- | :--- |
| **1. Email Search** | `UPPER(email)` function scan | 13 | **2** | 📉 **85%** |
| **2. Shipment Report** | Missing FK Indexes / Hash Join | 142 | **64** | 📉 **55%** |
| **3. Latest Orders** | Sort Order By (Temp Space) | 4472 | **22** | 📉 **99.5%** |
...
* [🇵🇱 **README_AI_AGENT_PL.md**](./agent_instructions/README_AI_AGENT_PL.md) - Instructions in Polish.
* [🇬🇧 **README_AI_AGENT_EN.md**](./agent_instructions/README_AI_AGENT_EN.md) - Instructions in English.
...
├── agent_instructions/         # 🤖 Prompts and instructions for AI Agent (PL/EN)
├── docs/                       # 🌐 Sources for GitHub Pages (index.html file)
│
├── sql/                        # 💾 SQL Scripts
│   ├── 01_setup/               # Environment setup "with problems" (04_logistics_setup.sql)
│   ├── 02_scenarios/           # "Bad" queries simulating failure (05_bad_performance_scenarios.sql)
│   ├── 03_solutions/           # Fix scripts generated by AI (07_performance_fixes.sql)
│   ├── 04_rag_engine/          # RAG procedures and vector management (06_rag_management.sql)
│   └── 05_analysis_metrics/    # Analytical scripts (50_*.sql, 51_*.sql)
│
├── INSTALL.md                  # ⚙️ Detailed installation instructions
└── README.md                   # 📖 This file
```
...
**🔗 Base configuration:** This project is a continuation of the [ora26ai-vector-rag-demo](https://github.com/krzysztof-i-cabaj/ora26ai-vector-rag-demo/) workshop. Make sure you have completed those steps (especially model loading).
